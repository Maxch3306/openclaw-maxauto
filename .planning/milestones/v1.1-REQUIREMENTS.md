# Requirements Archive: v1.1 Multi-Bot Telegram
...
- [x] **MBOT-08**: Each bot has its own DM policy and allow-list configuration
- [x] **MBOT-09**: Each bot has its own group policy and allow-list configuration
