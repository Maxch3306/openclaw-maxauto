      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="p-3">
          <button
            ...
            className="w-full flex items-center justify-center gap-2 px-3 py-2 rounded-lg border border-dashed border-border text-sm text-muted-foreground hover:text-foreground hover:border-primary hover:bg-secondary transition-colors"
          >
            <Plus size={16} />
            {t("sidebar.newAgent")}
          </button>
